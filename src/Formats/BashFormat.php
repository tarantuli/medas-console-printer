...
class BashFormat
{
    ...
    public const string UNDERLINED = '4';
    ...
    public const string LIGHT_GRAY = '37';
    public const string GRAY = '90';
    public const string LIGHT_RED = '91';
    public const string LIGHT_GREEN = '92';
    public const string LIGHT_YELLOW = '93';
    public const string LIGHT_BLUE = '94';
    public const string LIGHT_MAGENTA = '95';
    public const string LIGHT_CYAN = '96';
    public const string WHITE = '97';

    // Background colors
    public const string DEFAULT_BG = '49';
    public const string BLACK_BG = '40';
    public const string RED_BG = '41';
    public const string GREEN_BG = '42';
    public const string YELLOW_BG = '43';
    public const string BLUE_BG = '44';
    public const string MAGENTA_BG = '45';
    public const string CYAN_BG = '46';
    public const string LIGHT_GRAY_BG = '47';
    public const string GRAY_BG = '100';
    public const string LIGHT_RED_BG = '101';
    public const string LIGHT_GREEN_BG = '102';
    public const string LIGHT_YELLOW_BG = '103';
    public const string LIGHT_BLUE_BG = '104';
    public const string LIGHT_MAGENTA_BG = '105';
    public const string LIGHT_CYAN_BG = '106';
    public const string WHITE_BG = '107';

    // 256 color map prefixes
    public const string COLOR256 = '38;5;';
    public const string COLOR256_BG = '48;5;';

    // XTERM codes
    public const array XTERM256_CODES = [
        '#000000' => '0',
        '#800000' => '1',
        '#008000' => '2',
        '#808000' => '3',
